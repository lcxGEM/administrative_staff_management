package com.zzu.staff.management.util;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.zzu.staff.management.controller..*.*(..))")//切入点描述 这个是controller包的切入点 监控info日志的切入点
